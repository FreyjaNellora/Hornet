...
/// DKW / dead-army rule variant (EXP-026; `HORNET_DKW_RULE` = `0`/`1`/`2`,
...
///
/// **Default = 2**, the EXP-026 verdict: rule 1 (locked) is refuted in replay (dead pieces are
/// captured after the king falls); rules
...
pub struct Board {
    ...
    /// grammar from a mid-game chess.com FEN4 (it may encode the draw clock and/or
