...
//!
//! The other FEN4 dialect seen in `baselines/tactical_samples.json` (`xxx` corner cells,
//! space-separated trailer) is a legacy/Freyja format and is intentionally NOT handled
//! here; converting it is a separate concern for the strength-gate phase.
